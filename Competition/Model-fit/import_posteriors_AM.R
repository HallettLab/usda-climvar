...
params_avfa <- rbind(as.data.frame(lapply(avfa_dry, mean))[-7],
                     as.data.frame(lapply(avfa_wet, mean))[-7])
...
# Convert to data frame
params_brho <- rbind(as.data.frame(lapply(brho_dry, mean))[-7],
                     as.data.frame(lapply(brho_wet, mean))[-7])
...
# Convert to data frame
params_vumy <- rbind(as.data.frame(lapply(vumy_dry, mean))[-7],
                     as.data.frame(lapply(vumy_wet, mean))[-7])
...
# Convert to data frame
params_laca <- rbind(as.data.frame(lapply(laca_dry, mean))[-7],
                     as.data.frame(lapply(laca_wet, mean))[-7])
...
params_esca <- rbind(as.data.frame(lapply(esca_dry, mean))[-7],
                     as.data.frame(lapply(esca_wet, mean))[-7])
params_esca$species <- "esca"
params_esca$treatment <- c("fallDry","fallWet")

# Create total dataframe
params <- rbind(params_avfa, params_vumy, params_brho, params_esca, params_laca)
